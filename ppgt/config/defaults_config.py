...
def extended_cfg(cfg):
    ...
    cfg.vp_momentum = 1.    # adding momentum update to val_perf ---> to smooth the model selection based on val_perf


    # ------ for debugging -----
    cfg.train.cfi_only = False
    cfg.train.loss_threshold = 0.
