...
def set_cfg_gt(cfg):
    ...
    # ---------------  Unified PE Parser ----
    cfg.gt.pos_enc = CN()
    cfg.gt.pos_enc.enable = False

    # ---------- Jumping Knowledge ---------
    cfg.gt.jk = CN()
    cfg.gt.jk.enable = False
    cfg.gt.jk.mode = 'cat'
    ...
    #
    # cfg.gt.mixer = CN()
    # cfg.gt.mixer.token_mixer = CN()
    # cfg.gt.mixer.channel_mixer = CN()

    # ------ norm ----------
    cfg.gt.norm_fn = 'none'
    cfg.gt.macro_norm_type = 'post_norm'
    cfg.gt.post_backbone_norm = 'none'
    cfg.gt.pre_backbone_norm = 'none'
    cfg.gt.main_ranch_norm_idx = []
