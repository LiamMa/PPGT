...
def pre_transform_in_memory(dataset, transform_func, show_progress=True, cfg=dict(), posenc_mode=False, in_place=False):
    ...
    Args:
        ...
        in_place: directly chaning the original dataset or return new copy
    """
    if not in_place:
        dataset = dataset.copy()     # avoid affecting the original datasets
