...
@register_node_encoder('VOCNodeV2')
class VOCNodeEncoderV2(torch.nn.Module):
    def __init__(self, emb_dim):
        super().__init__()
...
@register_edge_encoder('VOCEdgeV2')
class VOCEdgeEncoderV2(torch.nn.Module):
    def __init__(self, emb_dim):
        super().__init__()
...
@register_node_encoder('COCONodeV2')
...
@register_edge_encoder('COCOEdgeV2')
